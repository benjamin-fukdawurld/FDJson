...
namespace FDJson
{
    namespace internal
    {
        ...
        struct map_helper
        {
            ...
            static rapidjson::Value serialize(Map &&m);

            template<typename Map>
            static rapidjson::Value serialize(const Map &m);

            template<typename Map>
            static bool unserialize(const rapidjson::Value &val, Map &m, std::string *err = nullptr);
        };
    ...
    rapidjson::Value> serialize(Container<Key, Value, Compare, Allocator> &&i);
    ...
    std::enable_if_t<std::is_same<Container<Key, Value, Compare, Allocator>, std::map<Key, Value, Compare, Allocator>>::value
                         || std::is_same<Container<Key, Value, Compare, Allocator>, std::multimap<Key, Value, Compare, Allocator>>::value,
    rapidjson::Value> serialize(const Container<Key, Value, Compare, Allocator> &i);
    ...
    std::enable_if_t<std::is_same<Container<Key, Value, Compare, Allocator>, std::map<Key, Value, Compare, Allocator>>::value
                         || std::is_same<Container<Key, Value, Compare, Allocator>, std::multimap<Key, Value, Compare, Allocator>>::value,
    bool> unserialize(const rapidjson::Value &val, Container<Key, Value, Compare, Allocator> &m, std::string *err = nullptr);
    ...
    rapidjson::Value> serialize(Container<Key, Value, Hash, KeyEqual, Allocator> &&i);
    ...
    std::enable_if_t<std::is_same<Container<Key, Value, Hash, KeyEqual, Allocator>, std::unordered_map<Key, Value, Hash, KeyEqual, Allocator>>::value
                         || std::is_same<Container<Key, Value, Hash, KeyEqual, Allocator>, std::unordered_multimap<Key, Value, Hash, KeyEqual, Allocator>>::value,
    rapidjson::Value> serialize(const Container<Key, Value, Hash, KeyEqual, Allocator> &i);
    ...
    std::enable_if_t<std::is_same<Container<Key, Value, Hash, KeyEqual, Allocator>, std::unordered_map<Key, Value, Hash, KeyEqual, Allocator>>::value
                         || std::is_same<Container<Key, Value, Hash, KeyEqual, Allocator>, std::unordered_multimap<Key, Value, Hash, KeyEqual, Allocator>>::value,
    bool> unserialize(const rapidjson::Value &val, Container<Key, Value, Hash, KeyEqual, Allocator> &m, std::string *err = nullptr);
}
